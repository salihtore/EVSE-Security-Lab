...
**Akış:**
1. BootNotification gönderilir
2. StartTransaction ile oturum başlar
3. MeterValues periyodik olarak gönderilir
4. StopTransaction ile oturum düzgün şekilde kapanır
...
2. **Saldırgan** ağ trafiğini dinler ve transactionId/idTag ele geçirir
3. **Saldırgan** kendi cihazından (farklı connector/IP) çalınan transactionId ile MeterValues gönderir
4. **Saldırgan** yanlış idTag ile StopTransaction göndererek oturumu kapatır
5. **Kurban** oturumun çalındığını fark eder
