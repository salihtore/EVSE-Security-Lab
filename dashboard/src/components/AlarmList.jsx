              ...
              {cpAlarms.map((alarm, i) => (
                ...
                >
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    ...
                    {alarm.details?.mitigation && alarm.details.mitigation.action !== "MONITOR_ONLY" && (
                      <span style={{ fontSize: "10px", color: "#60a5fa", opacity: 0.9 }}>
                        🛡️ {alarm.details.mitigation.action}
                      </span>
                    )}
                  </div>
